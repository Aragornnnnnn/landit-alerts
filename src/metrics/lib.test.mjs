...
test('위클리 메시지를 ANSI 코드 블록 하나로 스펙 그대로 조립한다', () => {
  ...
  assert.equal(
    ...
    [
      ...
      '',
      `${B('👥 주간 활성 412명')} ${G('+20')} · 7일 중 1인당 3.2일 접속`,
      `   유료 38명 ${G('+6')} · 5.1일`,
      `   무료 374명 ${G('+14')} · 3.0일`,
      '',
      ...
      '',
      B('🗣️ 시나리오 완료 210명 · 1인당 3.2개'),
      '   1개 61명 · 2개 38명 · 3개 29명 · 4개 22명 · 5개 18명 · 6개 15명 · 7개 27명',
      '   7개 완료 27명 · 유료 8명 / 무료 19명',
      '',
      B('💎 유료 38명이 일주일 동안 쓴 것'),
      '   시나리오 표현 29명 (76%) · 1인당 9.9개 · 시나리오 한 판당 2.4개 / 4개',
      '   스몰톡 21명 (55%) · 1인당 4.2판 · 한 판 평균 6.2턴',
      '   스몰톡 한 판에 말한 시간 · 평균 3분 10초 · 최소 40초 · 최대 9분 50초',
      '   스몰톡 표현 17명 (45%) · 1인당 3.6개 · 스몰톡 한 판당 0.7개',
      '',
      B('🔁 8/31~9/6 가입 71명'),
      '   하루 뒤 48% · 일주일 뒤 21% 남음',
      '',
